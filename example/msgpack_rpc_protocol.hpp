 ...
 */
 ...
 struct msgpack_rpc_protocol {
  public:
   ...
   using router = coro_rpc::protocol::router<struct_pack_protocol>;
 ...
 template <typename rpc_protocol = coro_rpc::protocol::msgpack_rpc_protocol>
 ...
 using context = coro_rpc::context_base<return_msg_type,
                                        coro_rpc::protocol::struct_pack_protocol>;
 
 template <typename rpc_protocol = coro_rpc::protocol::struct_pack_protocol>
