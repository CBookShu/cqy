 ...
 */
 ...
 class Generator<Ref, V, Allocator>::promise_type
     : public detail::gen_promise_base<yielded>,
       public ::async_simple::coro::detail::PromiseAllocator<Allocator> {
 public:
 ...
 public:
     ...
     iterator& operator++() {
        ::async_simple::logicAssert(this->operator bool(),
 ...
 Generator<Ref, V, Allocator>::begin() {
    ::async_simple::logicAssert(!!_coro, "Can't call begin on moved-from generator");
     _coro.resume();
